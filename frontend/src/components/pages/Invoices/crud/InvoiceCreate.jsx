				...
				<div className="card-body">
					...
					<div className="form-control">
						<label className="cursor-pointer label">
							...
							<input type="checkbox" checked={isNewPartner} onChange={(e) => setIsNewPartner(e.target.checked)} className="checkbox" />
						</label>
					</div>

					{!isNewPartner ? (
						<select value={selectedPartnerId} onChange={(e) => setSelectedPartnerId(e.target.value)} className="select select-bordered w-full">
